...
Ha $h^{(1)}$-t úgy választjuk, hogy merõleges legyen $U$ elsõ oszlopára, akkor ezzel eliminálhatjuk az elsõ szinguláris érték hatását. Ilyenkor tehát érdemes $\sigma_2$-vel normalizálni.
...
jelenséget \emph{tightly kit communities effect}-nek nevezték el. %TODO ezt hogyan lehet szépen megfogalmazni
\begin{lemma}
