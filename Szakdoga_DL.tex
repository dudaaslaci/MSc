...
Szeretnénk bemutatni a téma elõzményeit, fõbb fogalmait, mint a Laplace-mátrix, a Fiedler-vektor, vagy a Cheeger-konstans. 
...
A spektrálgráfelmélet az 1950-es közepétõl vált kutatott területté.
...
A gyakorlatban is sok haszna van a spektrumnak. Elõször a VLSI-áramkörök tervezésénél használták, de azóta számos más területen is sikeresen alkalmazták, mint a fehérjehálózatok, szociális hálók struktúrájának felderítése.
...
Jon Kleinberg 1998-ban született HITS (Hyperlink-Induced Topic Search) algoritmusa \cite{kleinberg99authoritative} az internetes oldalak fontosságát  határozza meg a köztük levõ hiperlinkek alapján.

Az algoritmus ötlete, hogy az oldalak két fontos csoportját keresi, a központi (hub) és a mértékadó (authority) oldalakat.
...
A feladat megfogalmazható az irányított gráfok nyelvén is. A weboldalak a csúcsok, az éleket pedig a hiperlinkek határozzák meg.  Az $auth,hub:V\rightarrow\mathbb{R}$ függvényeket használjuk majd az egyes oldalak mértékadóságának és központiságának meghatározására.
...
A két egyenletet egymásba helyettesítve a következõket kapjuk:
...
Most már jól látható, hogy a mértékadóság és a központiságot a szinguláris értékek és vektorok határozzák meg.
