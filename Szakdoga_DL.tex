...
Bemutatjuk a téma elõzményeit, olyan fõbb fogalmait, mint a Laplace-mátrix, a Fiedler-vektor, vagy a Cheeger-konstans. Ezt követõen pedig az ezekhez kapcsolódó fõbb eredményeket.
% Végül egy valós példán mutatjuk be a spektrálklaszterezés módszer egy lehetséges alkalmazását .
...
$\Sigma\in\mathbb{R}^{n\times m}$ ,,fõátlójában'' a
...
A heurisztika szerint egy oldal központiságát az határozza meg, hogy mennyire mértékadó oldalakra mutat rá.
...
Az (\ref{maxLemma}) lemma és (\ref{Qk})
alapján:
