...
Szeretnénk bemutatni a téma elõzményeit, fõbb fogalmait, mint a Laplace-mátrix, a Fiedler-vektor, vagy a Cheeger-konstans. Végül egy valós példán mutatjuk be egy lehetséges alkalmazását a módszernek.
\end{abstract}
\newpage
...
\end{defin}
Az elsõ két normaaxióma nyilvánvalóan teljesül, a háromszög-egyenlõtlenség pedig a Cauchy-egyenlõtlenség felhasználásával igazolható. A Cauchy-egyenlõtlenség vektorok skaláris szorzata és 2-normája közti kapcsolatot ír le:
...
Most áttérünk mátrixok normáinak tárgyalására. Két különbözõ mátrixnormát fogunk bevezetni és használni. Elõször a vektorok 2-normájához hasonló módon definiálunk mátrixnormát, amit \emph{Frobenius-normának} nevezünk:
...
\end{allitas} 
\begin{biz}
Az $A^{T}A$ mátrix fõátlójában szereplõ $j$-edik elem megegyezik az $A$ mátrix $j$-edik oszlopában elõforduló elemek négyzetösszegével. Így $\nyom{A^{T} A}$ nem más mint $A$ összes elemének négyzetösszege. Ezzel igazoltuk az elsõ egyenlõs
éget. 

Az \ref{FNormaSajatErt} összefüggés pedig az elsõ következménye, hiszen egy mátrix nyoma megegyezik sajátértékeinek összegével.
...
Végül az \ref{normaAegyAHegyAT} összefüggés a \ref{maxLambdaLemma} következménye,
...
A legtöbbször mégis más reprezentánsokat alkalmazzuk, a spektrumuk kedvezõbb tulajdonságai miatt.

\subsection{Laplace-mátrix és a normalizált Laplace-mátrix}
%TODO lehetne rögtön súlyozottakra mondani?
...
\subsection{Vágások}
Gondolhatjuk, hogy két csúcscsoport különbözik, hogyha könnyen el tudjuk választani õket. Tehát érdemes vizsgálni, hogy hány élet kell elhagyni, hogy  kettéválasszuk õket. Az ilyen élhalmazokat vágásoknak hívjuk.
...
Tetszõleges két csúcshalmazhoz meghatározhatjuk az általuk feszített részgráfban az elválasztásukhoz szükséges vágás értékét.
...
Legegyszerûbb a csúcshalmazok méretével normálni, ekkor kapjuk a kiegyensúlyozottság mértékét.
...
%TODO masik fele spektralklaszterezes leirasa
...
\subsection{A spektrálklaszterzés hátrányai}
...
A TKC-hatást okozó csomópontok megtalálására alkalmazhatjuk a SCAN-algoritmust\cite{xu2007scan}.
...
\begin{figure}[hbtp]
\centering
\includegraphics[scale=0.5]{pictures/klaszter_before.jpg} 
\caption{A csúcsok eloszlása 4. és 5. sajátirányok mentén elõfeldolgozás nélkül}
\end{figure}
\begin{figure}[hbtp]
\centering
\includegraphics[scale=0.5]{pictures/klaszter_after.jpg}
\caption{A csúcsok eloszlása 4. és 5. sajátirányok mentén elõfeldolgozással}
\end{figure}
...
\begin{figure}[hbtp]
\centering
\includegraphics[scale=0.5]{pictures/sdp_result.jpg}
\caption{A szemidefinit program kimenete}
\end{figure}
A szemidefinit program lett a legeredményesebb.
